  ...
  parts: [
    {
      ...
      details: [
        ...
        {name: 'Stanford', icon: {type: 'img', src: 'testbox'}, text: 'Barely behind us, Stanford earned honors for its commitment to sustainable agriculture in class and cafeteria.', ext: [{},{},{}]},
